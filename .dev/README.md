...
- Ти: відповіді `>` у [T25](.t/T25-Q--chats-questions.md) (⭐ Q1–Q3 визначають фазу 1) → я створюю задачу-теку з планом і починаю фазу 1 (реєстр чатів, picker, `/chats`, легкий `/setup`).
